...
import { Event } from "src/app/event-store";
...
export const reducers: ActionReducerMap<State, Event> = {
  auth: fromAuth.reducer,
  books: fromBooks.reducer,
};

export const metaReducers: MetaReducer<State, Event>[] = [logoutMetareducer];
